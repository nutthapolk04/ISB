...
- Do NOT ข้ามขั้นตอน TypeScript type check (`npx tsc --noEmit`) ก่อน commit

## Project Context
- Stack: React 18 + TypeScript + Vite
- UI Library: shadcn/ui (Radix UI + Tailwind CSS)
- i18n: react-i18next (en.json / th.json ใน src/locales/)
- Routing: React Router v6
- State: Local useState / useMemo (ไม่มี global store)
