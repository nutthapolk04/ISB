...
- Backend auth: `backend-bun/src/middleware/AuthMiddleware.ts` + `backend-bun/src/utils/AuthUtils.ts`
- API routes: `backend-bun/src/routes/`
- Config / secrets: `backend-bun/src/lib/config.ts`
