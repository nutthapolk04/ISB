...
const apiV1AuthedRoutes = new Elysia({ name: "api-v1-authed-routes" })
    ...
    .group("/users", (app) =>
        app
            ...
            .get("/resolve-scan/:q", UserController.resolveScan, UserSchema.resolveScan)
    ...
    .group("/reports", (app) =>
        app
            ...
            .get("/sales-by-cashier", ReportController.salesByCashier, ReportSchema.salesByCashierReport)
            ...
            .get("/receive-stock", ReportController.receiveStock, ReportSchema.receiveStockReport)
    ...
    .group("/shops", (app) =>
        app
            ...
            .get("/:shopId/topup-report", ShopController.topupReport, ShopSchema.shopTopupReport)
            ...
            .get("/:shopId/cashiers", ShopController.listCashiers)
            ...
            .post("/:shopId/price-panels/:panelId/reorder", ShopCatalogController.reorderPricePanelItems, ShopCatalogSchema.reorderPricePanelItems)
    ...
    .group("/kiosk", (app) =>
        app
            ...
            .post("/lock-alert", KioskController.lockAlert, KioskSchema.kioskLockAlert)
    )
    .group("/admin/departments", (app) =>
        app
            ...
            .patch("/:department_id/card", TopupController.bindDepartmentCard, TopupSchema.topupBindDepartmentCard)
    ...
    .group("/pos", (app) =>
        app
            ...
            .get("/transactions", PosController.listTransactions, PosSchema.posListTransactions)
            .get("/transactions/:id", PosController.getTransaction, PosSchema.posGetTransaction)
            ...
            .post("/qr-intent/:refCode/abandon", PosController.abandonQrIntent, PosSchema.posQrIntentAbandon)
            .post("/edc-intent", PosController.startEdcAttempt, PosSchema.posStartEdcAttempt)
            .post("/edc-intent/:refCode/abandon", PosController.abandonEdcAttempt, PosSchema.posEdcIntentAbandon)
            .post("/edc-intent/:refCode/verify-and-create", PosController.verifyEdcAndCreateReceipt, PosSchema.posVerifyEdcAndCreate)
    ...
    .get("/wallets/admin/balance-report", AdminReportsController.balanceReport, AdminReportsSchema.adminBalanceReport)
...
const publicAuthPlugin = new Elysia({ name: "public-auth", prefix: "/api/v1/auth" })
    ...
    .post("/sso/google/id-token", AuthController.googleSsoIdToken, AuthSchema.googleSsoIdToken);
