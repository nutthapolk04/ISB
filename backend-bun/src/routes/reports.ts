  ...
  .get(
    ...
    },
    {
      query: t.Object({
        ...
        date_to: t.String(),
        shop_id: t.Optional(t.String()),
        product_variant_id: t.Optional(t.String()),
      }),
      detail: {
  ...
  .get(
    ...
    },
    {
      query: t.Object({
        ...
        customer_type: t.Optional(t.String()),
        user_name: t.Optional(t.String()),
        family_code: t.Optional(t.String()),
        receipt_no_from: t.Optional(t.String()),
        receipt_no_to: t.Optional(t.String()),
        receive_type: t.Optional(t.String()),
        shop_id: t.Optional(t.String()),
        module: t.Optional(t.String()),
      }),
