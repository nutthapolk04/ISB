...
ALTER TABLE "receipts" ADD COLUMN "idempotency_key" varchar(64);--> statement-breakpoint
...
CREATE INDEX "ix_pos_failed_checkouts_idempotency_key" ON "pos_failed_checkouts" USING btree ("idempotency_key" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "ix_receipts_idempotency_key" ON "receipts" USING btree ("idempotency_key" text_ops) WHERE (idempotency_key IS NOT NULL);