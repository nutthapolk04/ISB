...
CREATE TYPE "public"."paymentmethod" AS ENUM('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'WALLET', 'BANK_TRANSFER', 'CARD_TAP', 'EDC', 'DEPARTMENT', 'OTHER');--> statement-breakpoint
...
ALTER TABLE "shops" ADD CONSTRAINT "shops_spending_group_id_fkey" FOREIGN KEY ("spending_group_id") REFERENCES "public"."spending_groups"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ix_shops_spending_group" ON "shops" USING btree ("spending_group_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "ix_receipts_payer_shop_date" ON "receipts" USING btree ("payer_user_id" int4_ops,"customer_id" timestamptz_ops,"payer_department_id" int4_ops,"spending_group_id" int4_ops,"transaction_date" timestamptz_ops) WHERE (status = 'ACTIVE'::receiptstatus);--> statement-breakpoint
...
CREATE UNIQUE INDEX "ix_wallets_user_id" ON "wallets" USING btree ("user_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "ix_audit_logs_entity" ON "audit_logs" USING btree ("entity_type" int4_ops,"entity_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "ix_product_order_history_shop" ON "product_order_history" USING btree ("shop_id" int4_ops,"version" int4_ops);--> statement-breakpoint
...
CREATE INDEX "ix_identity_mappings_entity" ON "identity_mappings" USING btree ("entity_type" int4_ops,"entity_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "ix_sync_audit_entity" ON "sync_audit_logs" USING btree ("entity_type" int4_ops,"entity_id" text_ops);--> statement-breakpoint
...
CREATE INDEX "ix_shop_products_sort" ON "shop_products" USING btree ("shop_id" text_ops,"sort_order" text_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "ix_spending_groups_code" ON "spending_groups" USING btree ("code" text_ops);
*/