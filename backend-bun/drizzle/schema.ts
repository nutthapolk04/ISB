...
export const paymentmethod = pgEnum("paymentmethod", ['CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'WALLET', 'BANK_TRANSFER', 'CARD_TAP', 'EDC', 'DEPARTMENT', 'OTHER'])
...
export const syncAuditLogs = pgTable("sync_audit_logs", {
	...
	index("ix_sync_audit_entity").using("btree", table.entityType.asc().nullsLast().op("int4_ops"), table.entityId.asc().nullsLast().op("text_ops")),
