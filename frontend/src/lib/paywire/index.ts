// Vendored from docs/edc/sdk-js (@paywire/sdk-js v0.0.1) — replace with a
// workspace package later. Copied verbatim from client.ts/types.ts/errors.ts;
// see edcClient.ts in this folder for the app-level singleton wrapper.
