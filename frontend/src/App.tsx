...
import { MockBayPaymentForm, MockBayPaymentSuccess, MockBayPaymentCancel } from './pages/payment/MockBayGateway';
              ...
              {user && (
                <div className="flex items-center gap-2 border-l border-border/60 pl-2">
                  <div className="flex items-center gap-1.5 text-sm">
                    ...
                    <span className="hidden sm:inline text-muted-foreground">{user.fullName}</span>
                  ...
                  <Button variant="ghost" size="icon" onClick={logout} title={t('account.signOut')}>
