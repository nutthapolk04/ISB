...
const menuGroups: MenuGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { titleKey: "nav.storeReports", url: "/store/reports", icon: BarChart3, roles: ["admin", "manager", "finance"] },
            { titleKey: "nav.storeTopupReport", url: "/store/topup-report", icon: Wallet, roles: ["manager"] },
