    ...
    const cards: FamilyCard[] = [
        ...(ownWallet
            ? [{
                ...
                code: ownWallet.external_id ?? ownWallet.student_code ?? ownWallet.customer_code ?? ownWallet.username ?? "",
        ...
        ...coParents.map((cp) => ({
            ...
            code: cp.external_id ?? cp.username ?? "",
        ...
        ...children.map((ch) => ({
            ...
            code: ch.external_id ?? ch.student_code ?? ch.customer_code,
            cardUid: ch.card_uid,
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-center justify-center gap-2 flex-wrap">
                            <span className="bg-white/20 text-white/90 text-[0.65rem] rounded-full px-2.5 py-0.5">
                                {t("parent.dashboard.idNumber", "ISB ID Number")}: {studentWallet.external_id ?? studentWallet.student_code ?? studentWallet.customer_code ?? "—"}
                            </span>
                            {/* <span className="bg-white/20 text-white/90 text-[0.65rem] rounded-full px-2.5 py-0.5">
